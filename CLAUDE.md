...
- 線上 https://3d-xiangqi.pages.dev = 最新(SW `3d-xiangqi-v9`;renderer 含 `rotateZ`;app.js 含 `sendBeacon`)。
- 測試:`npm test` 251/0;`node scripts/browser-check.mjs` 18/0(本機與線上都跑過;含攔 play-stats 請求驗開啟/完賽打點真的送出)。
